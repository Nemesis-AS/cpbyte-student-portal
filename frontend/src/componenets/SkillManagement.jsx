...
function SkillManagement() { 
  ...
  return ( 
    <div className="p-6 w-full"> 
      ...
      <p className="text-sm text-gray-500 dark:text-g ray-400 mb-6">
        Update your skill set to showcase your expertise. 
      </p> 
      <div className="rounded-lg p-6 w-full flex flex-col  space-y-6 bg-gray-800">
        <div className="flex flex-col sm:flex-row sm:item s-center sm:space-x-4 space-y-4 sm:space-y-0">
        ...
        <div className="flex flex-wrap gap-4"> 
          {skills.map((skill, index) => (  
            ...
            > 
              <div className="flex justify-center items-c enter border-r p-2 px-4 border-gray-600 text-gray-300 font-medium">
                {skill}  
              </div> 
              <button 
